...
import { BookOpenIcon, BrainIcon, ChevronRightIcon, ListChecksIcon, BookmarkIcon, ShareIcon } from "lucide-react"
    ...
    <>
      <Tabs defaultValue="technology" value={activeTab} onValueChange={setActiveTab}>
        <TabsContent value="technology" className="mt-0">
          ...
          >
            <AnimatePresence>
              {newsData.technology.map((article) => (
                <NewsCard
                  key={article.id}
                  article={article}
            ...
            {dialogMode === "summary" ? (
              ...
              >
                ...
                <div className="flex justify-between pt-2">
                  <Button variant="outline" size="sm" onClick={() => setDialogMode("points")}>
              ...
              >
                ...
                <div className="flex justify-between pt-2">
                  <Button variant="outline" size="sm" onClick={() => setDialogMode("summary")}>
...
function NewsCard({
  ...
  return (
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3 }}>
      <Card className="overflow-hidden group h-full flex flex-col border-none shadow-md hover:shadow-lg transition-shadow duration-300">
        ...
        <CardHeader className="p-4 pb-0">
          ...
          <CardTitle className="line-clamp-2 mt-2 text-lg group-hover:text-yellow-600 dark:group-hover:text-yellow-400 transition-colors">
            {article.title}
          </CardTitle>
        </CardHeader>
        ...
        <CardFooter className="flex justify-between p-4 pt-0">
          <div className="flex gap-2">
            <Button
              variant="outline"
              size="sm"
              className="h-8 px-2 border-yellow-200 hover:bg-yellow-50 hover:text-yellow-700 dark:border-yellow-900 dark:hover:bg-yellow-900/30 dark:hover:text-yellow-400"
              onClick={() => onSummarize(article)}
            >
              <BrainIcon className="mr-1 h-4 w-4 text-yellow-500" />
            ...
            >
              <ListChecksIcon className="mr-1 h-4 w-4 text-yellow-500" />
          ...
          <Button
            variant="ghost"
            size="sm"
            className="h-8 px-2 text-yellow-600 hover:text-yellow-700 hover:bg-yellow-50 dark:text-yellow-400 dark:hover:text-yellow-300 dark:hover:bg-yellow-900/20"
          >
